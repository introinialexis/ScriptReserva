//<script>
var data = '<div class="CloudBedsWidget floatWrapper  ver-" data-lang="en"><div class="float_bg2">'+
'<div action="https://hotels.cloudbeds.com/en/reservation/PwV2JI" target="_blank" method="post" class="widgetHotelsForm float " autocomplete="off">'+
'<input type="hidden" name="date_format" value="d/m/Y" />'+
'<div class="acessa_float_left acessa_float_description"><div>Book direct with us for the best prices!</div></div>'+
'<div class="building"><label for="destination">Hostel:</label>'+
'<select name="destination" id="dest">'+
'<option id="Tulum" value="Oryx Tulum">Oryx Tulum</option>'+
'<option id="Valladolid" value="Oryx Valladolid">Oryx Valladolid</option></select>'+
'<div class="acessa_float_left acessa_float_dates">'+
'<div class="dates_group">' +
'<div class="form_group start_date"><label class="control-label" for="widget_date_1276"  title="Check In">Check In</label>' +
'<div class="input_group"><input type="text" class="date" name="widget_date" id="widget_date_1276" value="08/08/2022">' +
'<input type="date" name="start_date_mobile" class="date_mobile widget_hide" id="start_date_mobile"></div>' +
'</div>' +
'<div class="form_group end_date"><label class="control-label" for="widget_date_to4785"  title="Check Out">Check Out</label>' +
'<div class="input_group"><input type="text" class="date" name="widget_date_to" id="widget_date_to4785" value="09/08/2022">' +
'<input type="date" name="end_date_mobile" class="date_mobile widget_hide" id="end_date_mobile"></div>' +
'</div>' +
'</div>' +
'<a class="submit_link" target="_blank" href="https://hotels.cloudbeds.com/en/reservation/PwV2JI">Search</a>' +
'</div>'+
'</div>'+
'</div></div>';
...
"bookingUrl": "https:\/\/hotels.cloudbeds.com\/en\/reservation\/PwV2JI",
